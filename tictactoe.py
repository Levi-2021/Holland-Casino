    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if view.current_player == view.X:
            if interaction.user != player1:
                ...
                content = f"{player2.mention}'s turn"
            ...
            if interaction.user != player2:
                ...
                content = f"{player1.mention}'s turn"
...
class tictactoe(commands.Cog):
    ...
    @app_commands.command(name="tic-tac-toe", description="Play tic tac toe with a friend")

    async def tictactoe(self, inter:discord.Interaction, member: discord.Member):
        if inter.guild == None:
            ...
            await inter.response.send_message(f"{member.mention}'s turn", view=TicTacToe())
